...
# 
# APPROACH:
#   Start with the pandigital numbers that are multiples of 17.
#   Then keep moving down, with the multiples of 13, 11...
#   This way the pandigital number with the condition can be obtained.
