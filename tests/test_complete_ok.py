...
def assure_041(self):
    from Complete.E041 import result
...
def assure_054(self):
    from Complete.E054 import result
...
def assure_071(self):
    from Complete.E071 import result
    self.assertEqual(result, 428570)

def assure_072(self):
    from Complete.E072 import result
    self.assertEqual(result, 303963552391)

def assure_073(self):
    from Complete.E073 import result
...
def assure_080(self):
    from Complete.E080 import result
    self.assertEqual(result, None)
